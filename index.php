  ...
  <div class="row">
    <div class="col-md-8">
      <table class="table table-bordered table-hover table-striped bg-white">
        ...
        <tr>
          <th>Hash <a class="copyicon" data-clipboard-target="#blockhash"><img src="https://cdnjs.cloudflare.com/ajax/libs/octicons/8.0.0/svg/clippy.svg" /></a></th>
          <td class="text-truncate"><span id="blockhash"><?php echo $block->hash; ?></span></td>
        </tr>
        <tr>
          <th>Time</th>
          <td><?php echo date("Y-m-d H:i:s", $block->time); ?></td>
        </tr>
        <tr>
          <th>Transactions</th>
          <td><?php echo $block->nTx; ?></td>
        ...
        <tr>
          ...
          <td class="text-truncate"><a href="<?php echo blocklink($block->previousblockhash); ?>"><?php echo $block->previousblockhash; ?></a></td>
        </tr>
        <tr>
          <th>Next block</th>
          <td class="text-truncate"><?php if(isset($block->nextblockhash)): ?><a href="<?php echo blocklink($block->nextblockhash); ?>"><?php echo $block->nextblockhash; ?></a><?php endif; ?></td>
        </tr>
        </tbody>
      </table>
    </div>
...
<?php $i = 0; foreach($block->tx as $tx): $i++?>
        <li class="list-group-item d-flex justify-content-between lh-condensed <?php if(isset($_REQUEST['txid']) && $tx == $_REQUEST['txid']) echo "active"; ?>">
...
<?php elseif($VIEWTYPE == ViewType::Transaction): ?>
  ...
  <div class="row">
    <table class="table table-bordered table-hover table-striped bg-white">
      <tbody>
      <tr>
        <th>txid <a class="copyicon" data-clipboard-target="#txid"><img src="https://cdnjs.cloudflare.com/ajax/libs/octicons/8.0.0/svg/clippy.svg" /></a></th>
        <td><span id="txid"><?php echo $tx->txid; ?></a></td>
      </tr>
      <tr>
        <th>Hash</th>
      ...
      <tr>
        <th>Feerate</th>
        <td><?php if (isset($tx->fee)) echo round($tx->fee*100000000/$tx->size, 3); else echo "N/A"; ?> sat/B</td>
      </tr>
      <?php endif; ?>
      </tbody>
    </table>
